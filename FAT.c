...
void FATAllocation(int file_sizes[], int num_files, int disk_size) {
    int i, j;
    int disk[MAX_BLOCKS];
    int FAT[MAX_BLOCKS];
    ...
    for (i = 0; i < num_files; i++) {
        ...
        FAT[current_block] = -1; // End of file
...
int main() {
    ...
    FATAllocation(file_sizes, num_files, disk_size);
    return 0;
}
